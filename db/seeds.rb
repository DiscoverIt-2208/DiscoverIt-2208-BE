...
Favorite.create(user_id: user1.id, place_id: "1", place_name: "Cookie Center", thumbnail_url: "bkabkabkabka", city: "Denver", state: "Colorado", country: "United States", address: "whatever")
Favorite.create(user_id: user1.id, place_id: "2", place_name: "Poke Center", thumbnail_url: "blablablabla", city: "Denver", state: "Colorado", country: "United States", address: "whatever")
