RSpec.describe Hotel do
  ...
  :properties=>
   {:name=>"Hôtel Méridien Etoile",
    ...
    :categories=>["accommodation", "accommodation.hotel", "building", "building.accommodation", "wheelchair", "wheelchair.yes"],
    :details=>["details", "details.building", "details.contact", "details.facilities", "details.wiki_and_media"],
    :datasource=>
